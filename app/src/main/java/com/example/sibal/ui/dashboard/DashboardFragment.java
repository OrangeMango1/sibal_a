...
//        int totalIncome = calculator.calculateMonthlyIncome(targetMonth);
        ...
        // 수입과 지출을 UI에 반영
//        revenueTextView.setText(String.valueOf(totalIncome));
//        expenditureTextView.setText(String.valueOf(totalExpense));
        // 월별 지출을 형식화된 문자열로 변환하여 TextView에 설정
        expenditureTextView.setText(numberFormat.format(totalExpense));

//        expenditureDailyTextView.setText(String.valueOf(totalDailyExpense));
